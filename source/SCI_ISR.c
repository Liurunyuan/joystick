...
static void configPara47(VAR16 a, int b, int c) {
	gConfigPara.Trim_StepSize = (int)a.value;
}
static void configPara48(VAR16 a, int b, int c) {
	gConfigPara.Trim_Speed = (int)a.value;
}
/*****************************************************************/
